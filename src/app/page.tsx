    ...
    <div className="w-full">
      <div className="flex w-full flex-col items-center gap-16 px-4 lg:px-16">
        <div className="grid grid-cols-1 gap-x-4 gap-y-8 lg:grid-cols-2">
          <Image className="h-52 w-auto place-self-center" src={brand} alt="" />

          <div className="space-y-8 text-center lg:text-left">
            <h1 className="text-5xl">27 e 28 de Setembro</h1>
            <p className="leading-relaxed">
              Participe do Python Norte 2024, um evento dedicado à tecnologia e
              à inclusão! Estamos comprometidos em promover a diversidade e a
