  ...
  return (
    <div>
      <div className="my-8">
        ...
        <p className="mt-6 text-lg leading-loose">
          Com esta finalidade, a organização do evento conta com uma Equipe de
          Resposta que atua para garantir um ambiente com essas qualidades.
        </p>
        <p className="mt-6 text-lg leading-loose">Por isso: </p>
        <ul className="mt-6 text-lg leading-loose">
          <li>
            • Não é tolerado nenhum tipo de assédio, discriminação inapropriada
        ...
        <ul className="mt-6 text-lg leading-loose">
          <li>
            • Assédio é a ação de insistir, perseguir ou coagir outra pessoa a
            um comportamento involuntário.;
          </li>
          <li>
            • Discriminação inapropriada é o ato de separar, injuriar ou
            humilhar alguém promovendo sua exclusão por atributo particular da
            mesma.
          </li>
          <li>
